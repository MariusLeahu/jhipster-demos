...
import { DeviceDialogComponent } from '../../../../../../main/webapp/app/entities/device/device-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Device Management Dialog Component', () => {
        let comp: DeviceDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(DeviceDialogComponent, '')
            .compileComponents();
        }));
